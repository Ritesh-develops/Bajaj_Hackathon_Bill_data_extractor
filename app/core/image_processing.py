...
class ImageProcessor:
    ...
    @staticmethod
    def image_to_bytes(image: np.ndarray, format: str = 'jpeg', quality: int = 50) -> bytes:
        """Convert OpenCV image to bytes (JPEG quality 50 for faster Gemini processing - aggressively optimized)"""
